...
# prefix_taskname = "gitbench"
prefix_taskname = "deepseek"
...
class PathManager:
    ...
    def generate_task_id():
        ...
        return f'{prefix_taskname}_{date_str}'
            ...
            "config_list": [
                {
                    ...
                    "api_key": "sk-CDohUtHw3E63lqUoXIdaME4h16AMI4Rn13p2LjQAFFmWvcxq",
                    "base_url": "http://10.10.1.13:8081/v1",
                }
            ],
            "timeout": timeout,
            "temperature": temperature,
...
class AgentRunner:
    ...
    def run_agent(task_info, retry_times=2):
        ...
        # 创建工作目录
        work_dir = f'{work_task_path}/{task_id}/repo'
